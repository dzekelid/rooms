...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/rooms/master/_listings/cisco-webex/apis.md
...
- name: Webex Teams API - List rooms
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rooms/master/_listings/cisco-webex/rooms-get-openapi.md
- name: Webex Teams API - Create a webhook (all events, all rooms)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rooms/master/_listings/cisco-webex/webhooks-post-openapi.md
- name: Webex Teams API - List memberships (for all rooms)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/rooms/master/_listings/cisco-webex/memberships-get-openapi.md
x-common:
